"""
Classroom Report & Analytics — Streamlit UI (legacy).
...
def _parse_slides(slide_file):
    ...
    if slide_file is None:
        return "", ""
    from classroom_report.pipeline.ingest import parse_slides_bytes
...
def _parse_responses(excel_file, answer_key):
    ...
    from classroom_report.pipeline.ingest import parse_responses_bytes
...
def _ensure_analytics_data():
    ...
    try:
        ...
        return str(e)
    from classroom_report.pipeline.ingest import run_analytics
...
if page == "Upload":
    ...
    if _get_slide_file() is None or _get_excel_file() is None:
        ...
        from classroom_report.llm.ollama_client import OllamaClient, check_ollama_available
